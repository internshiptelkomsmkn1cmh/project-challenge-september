...
export default class Hasil extends Component {
        ...
        axios
            ...
            .then((res) => {
                swal({
                    ...
                    text: data.product.nama + " Pesanan Telah Di Update",
                    icon: "success",
                    button: false,
                    timer: 1500
                });
    ...
    hapusPesanan = (id) => {
        ...
        axios
            ...
            .then((res) => {
                swal({
                    title: "Hapus Pesanan",
                    text: this.state.keranjangDetail.product.nama + " Pesanan Telah Di Hapus",
                    icon: "error",
                    button: false,
                    timer: 1500
                });
    ...
    render() {
        ...
        return (
            <Col className='hasil' md={3} mt="2">
                <h4 className='fw-bold'>Hasil</h4>
                <hr/> {
                    keranjangs.length !== 0 && (
